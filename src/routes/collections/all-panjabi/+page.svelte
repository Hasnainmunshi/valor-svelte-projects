<script>
	...
	let newCollection = products.slice(0, 20);
</script>

<section class="pt-20 px-6 md:px-16">
	<h1 class="lg:text-4xl text-3xl font-semibold lg:font-bold text-gray-800 lg:pl-52">
		Explore All Panjabis
	</h1>
	<p class="mb-8 lg:pl-52 mt-3 text-gray-600">
		Explore our full collection of Panjabis, offering a variety of styles, fabrics, and colors for
		every occasion. Find your perfect fit with ease
	</p>
	...
	<div class="flex items-center justify-center mt-8">
		<button
			on:click={() => goto('/collections/view-allPanjabi')}
