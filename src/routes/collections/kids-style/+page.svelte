<script>
	...
	let newCollection = products.filter((item) => item.category === 'Kids Platinum');
</script>

<section class="mt-6">
	<div class="bg-gray-200 p-8">
		<h2 class=" lg:text-4xl text-3xl lg:pl-52 font-semibold lg:font-bold">Valor Kids Collection</h2>
	</div>
